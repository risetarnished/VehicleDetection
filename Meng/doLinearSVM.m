...
%           before using the best cost value to train, validate, and test

%% Grid search - Look for the value of cost that produces the best accuracy
cost = linspace(1, 50, 50);
...
title('Linear - Determining Cost Value');
xlabel('Cost');
...
%% Use the calculated cost value to train, test, and test
